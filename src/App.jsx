  ...
  return (
    <div style={{fontFamily:"'Courier New',monospace"}}>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center",marginBottom:14,padding:"8px 12px",background:"#080810",border:"1px solid #1e1e2e",borderRadius:10}}>
        ...
        <button onClick={()=>{stopAllNotes();setIsListening(false);setEditMode(true);}} style={{padding:"5px 13px",borderRadius:9,border:"1px solid #4466cc",background:"#1e2a4a",color:"#88aaff",fontWeight:700,fontSize:11,cursor:"pointer",fontFamily:"monospace"}}>✏️ Editar teclado</button>
